...
public class Quad extends Mesh {
    ...
    public Quad(float sizeX, float sizeY) {
        ...
        vertex1.setVector3f("modelSpaceVertexPosition", new Vector3f(0, 0, 0));
        ...
        vertex2.setVector3f("modelSpaceVertexPosition", new Vector3f(sizeX, 0, 0));
        ...
        vertex3.setVector3f("modelSpaceVertexPosition", new Vector3f(sizeX, sizeY, 0));
        ...
        vertex4.setVector3f("modelSpaceVertexPosition", new Vector3f(0, sizeY, 0));
